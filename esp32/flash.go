...
const blockLengthWriteMax uint32 = 0x8000
...
func (e *ESP32ROM) ReadFlash(offset uint32, size uint32) ([]byte, error) {
    ...
    for {
        ...
        if blockLength > blockLengthReadMax { blockLength = blockLengthReadMax }
        ...
        if err != nil { return receivedData, err }
...
func (e *ESP32ROM) WriteFlash(offset uint32, data []byte) error {
    ...
    for {
        ...
        if blockLength > blockLengthWriteMax { blockLength = blockLengthWriteMax }
